        ...
        <table className="min-w-full bg-white border border-gray-300">
          <thead>
            <tr className="border-b border-gray-300 bg-gray-100">
              ...
              <th className="py-3 px-6 text-left text-gray-700 uppercase">Cart</th>
            ...
            {list.map((item) => (
              ...
              >
                ...
                <td className="py-4 px-6">
                  <button className="bg-green-500 text-white py-2 px-4 rounded-md font-semibold hover:bg-blue-600"
